...
-   use R and RStudio to read, write, and edit R code
-   use GitHub for version control and collaboration
-   read and write spatial data from a wide range of file formats and web services
-   tidy, transform, and visualize data to understand the spatial and non-spatial attributes
-   measure the spatial attributes or relationships between features and transform feature geometry
-   use Quarto to create presentations and reproducible reports
...
Both books are available for free online or available for purchase as a physical copy from online retailers. Additional open access readings are listed on the page for each week's session.
...
Weekly check-in assignments must be submitted before 11:59 pm on the day *before* each class session. No late responses will be accepted for the weekly check-in.
...
Class sessions may include short quizzes or collaborative learning activities. These activities, including quizzes, are graded based on completion—not on correct or incorrect answers. If you are unable to participate in an in-class activity, bonus act
...
The details of the final project may change in the next few weeks. Please look out for updates.
:::
...
<!-- The final project is an opportunity for students to focus on the "models of local practice" described in *All Data Are Local*. -->
...
[Learn more about the final project](final-project.qmd).
...
-   An recorded **project presentation** <!-- delivered in-class on **December 6 - tentative**.-->
-   A **project repository** <!-- completed by **December 14 - tentative**. -->

Evaluation of the final project will be based on both self-assessment and an instructor assessment. The instructor can also offer bonus points in recognition of exceptional work or, if necessary, adjust points awarded through the student self-assessment.
...
You can earn up to a total of 100 points in this class by attending and completing in-class activities (25 points), submitting weekly check-ins (15 points), completing practice exercises (20 points), and completing all four parts of the final project (40 points).

| Assessment                             | Points |
|----------------------------------------|--------|
| Attendance/In-class activities         | 25     |
| Weekly check-in                        | 15     |
...
For questions or guidance regarding religious observance accommodations, please contact the Office of Equity and Civil Rights (ECR) at [ecr\@umbc.edu](mailto:ecr@umbc.edu).
