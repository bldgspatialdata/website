...
{{< include _include-website-exercise.qmd >}}
...
You *will* need the `{spData}` package but don't load them yet. If they aren't installed, install them now using `{pak}` (a faster option than `install.packages()`).
