...
1.  A project proposal (due **November 13 - updated**)
2.  An short presentation about your project (due **December 6 - tentative**)
3.  A project GitHub repository including code, data, output files, and a README (due **December 14 - tentative**)
