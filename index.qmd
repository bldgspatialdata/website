...
tbl <- tibble::tribble(
          ...
          "[5](weeks/week_05.html)", "2023-09-27",              "Applying spatial transformations and geometric operations using sf", "[📖](slides/spatial-data.html)", "[📝](exercises/exercise_05.html)",
