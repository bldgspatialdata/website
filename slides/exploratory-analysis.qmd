...
<!-- FIXME: Consider removing this section -->
...
This next section is largely excerpted from [R for Data Science (2e) - 11  Exploratory data analysis](https://r4ds.hadley.nz/EDA.html#introduction).
...
-   [gtsummary](https://www.danieldsjoberg.com/gtsummary/): Presentation-Ready Data Summary and Analytic Result Tables
...
-   [esquisse](https://dreamrs.github.io/esquisse/): RStudio add-in to make plots interactively with ggplot2
...
From [The Art of Data Science](https://bookdown.org/rdpeng/artofdatascience/) (2017) by Roger D. Peng and Elizabeth Matsui:
...
## Tools for exploring data with visualizations
