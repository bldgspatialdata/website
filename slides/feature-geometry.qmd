---
title: "Session {{< meta order >}}: Working with spatial and geometric operations in `{sf}`"
order: 5
...
```{r}
us_highways[st_is_within_distance(us_highways, maryland, dist = units::set_units(100, "mi")),]
```
