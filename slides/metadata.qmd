...
::: footer
Portions of these are adapted or inspired by a fall 2022 lecture by [Reina Chano Murray](https://github.com/reinacmurray/) ([repo](https://github.com/reinacmurray/documenting-spatial-data-class/)).
:::
...
![Excerpt from [Seeing Standards: A Visualization of the Metadata Universe](https://jennriley.com/seeing-standards-a-visualization-of-the-metadata-universe/) ([CC BY-NC-SA 3.0 US](https://creativecommons.org/licenses/by-nc-sa/3.0/us/)) (2010)](images/Excerpt_2010_Seeing-Standards_Jenn-Riley_BY-NC-SA.png){width="100%"}
...
-   [OpenGeoMetadata](https://opengeometadata.org/ogm-aardvark/)
