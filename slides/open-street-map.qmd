...
-   **Practice**: Downloading data with `{osmdata}`
...
Learn more in the [Good practice section](https://wiki.openstreetmap.org/wiki/Good_practice) of the [OpenStreetMap Wiki](https://wiki.openstreetmap.org/).
...
## Practice editing data with the iD Editor
