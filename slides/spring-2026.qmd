...
-   Reminder
    -   Exercise 4 is available - due Wednesday, 3/11
...
How do you decide the “right” structure for a dataset when it can be organized in more than one tidy way?
...
How much does it matter when making the decision on what function to use when smoothing?
...
How do you choose when to use `st_intersection()` vs. `st_join()` when looking at relationships between layers?
