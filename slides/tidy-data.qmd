...
- Make it easier to document and share
- Combine data from a variety of sources
- Use data with some other service (e.g. geocoding)

### Where does untidy data come from?

- Software (e.g. Excel issues with auto-formatting of dates)
- Intentional and unintentional choices by users (e.g. color-coding to encode status or spelling errors)
- Policy changes (e.g. adding or removing categories in a scale)
...
See [Tidy data](https://tidyr.tidyverse.org/articles/tidy-data.html) vignette or the [Tidy data paper](https://vita.had.co.nz/papers/tidy-data.html) by Hadley Wickham (2014) for more details.

::: notes
from Tidy data vignette https://tidyr.tidyverse.org/articles/tidy-data.html
:::

### How can we use the tidyverse for tidying?

Tidying data often requires you to use packages focused on different types of data:

- [stringr](https://stringr.tidyverse.org/) for [strings](https://r4ds.hadley.nz/strings.html) (and [regular expressions](https://r4ds.hadley.nz/regexps.html))
- [forcats](https://forcats.tidyverse.org/) for [factors](https://r4ds.hadley.nz/factors.html) (aka categorical variables)
- [lubridate](https://lubridate.tidyverse.org/) for [date and times](https://r4ds.hadley.nz/datetimes.html)

### What else can we use for tidying?

There are also specialized packages that can help:

- [janitor](https://sfirke.github.io/janitor/index.html) for "examining and cleaning dirty data"
- [naniar](https://naniar.njtierney.com/) to help "summarise, visualise, and manipulate missing data"
- [tidylog](https://github.com/elbersb/tidylog) provides "feedback about dplyr and tidyr operations" (useful for interactive coding especially as a beginner)

### What else can we use for tidying?

There are also non-R tools that can be helpful:

- [Tabula](https://tabula.technology/) for extracting tables from PDFs
- [OpenRefine](https://openrefine.org/) for reproducibly cleaning messy data
- [Airtable](https://www.airtable.com/) for integrating tables into databases

## Using tidyr

Categories of `{tidyr}` functions:
