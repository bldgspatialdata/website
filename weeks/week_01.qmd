...
Welcome to Building Spatial Datasets! Our first class starts with a broad introduction to the class, an introduction to the fundamental concepts and skills of reproducible data analysis, and an introduction to using R for working with spatial data.
